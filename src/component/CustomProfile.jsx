...
const CustomProfile = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            const response = await axios.post('http://localhost:8000/save-question', formData, {
    ...
    const loadQuestions = async () => {
        try {
            const response = await axios.get('http://localhost:8000/get-questions');
    ...
    const handleDelete = async (questionToDelete, videoPath) => {
        try {
            const response = await axios.delete('http://localhost:8000/delete_custom_question', {
